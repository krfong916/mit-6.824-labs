...
// 			fmt.Printf("DEBUG: ATTEMPT %v\n", v)
// 			if ok && cfg.connected[i] {
// 				fmt.Printf("DEBUG: COMMITTED %v\n", v)
// 				fmt.Printf("DEBUG: NEXT TO DISCONNECT %v\n", i)
// 				leader = i
// 			}
// 		}

// 		if (rand.Int() % 1000) < 100 {
// 			fmt.Println("DEBUG: LONG TIMEOUT")
// 			ms := rand.Int63() % (int64(RaftElectionTimeout/time.Millisecond) / 2)
// 			time.Sleep(time.Duration(ms) * time.Millisecond)
// 		} else {
// 			fmt.Println("DEBUG: SHORT TIMEOUT")
// 			ms := (rand.Int63() % 13)
// 			time.Sleep(time.Duration(ms) * time.Millisecond)
// 		}
...
// 	for i := 0; i < servers; i++ {
// 		if cfg.connected[i] == false {
// 			fmt.Printf("DEBUG: ALTOGETHER, RECONNECT %v\n", i)
// 			cfg.connect(i)
// 		}
// 	}
// 	v := rand.Int() % 10000
// 	fmt.Printf("DEBUG: AGREEMENT ON %v", v)
